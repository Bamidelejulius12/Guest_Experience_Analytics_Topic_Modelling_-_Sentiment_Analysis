...
def root():
    return {
        "message": "montra experience analytics and sentiment analysis API is up and running",
        "status": "active",
        "docs": "docs"
    }
...
async def predict_batch(file: UploadFile = File(...)):
    """upload a csv with the review text column and get back predictions on all the csv file data"""
    try:
